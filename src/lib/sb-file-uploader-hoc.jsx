    ...
    class SBFileUploaderComponent extends React.Component {
        ...
        createFileObjects () {
            ...
            if (FileSystemAPI.available()) {
                ...
                this.inputElement.accept = '.uqb1,.sb,.sb2,.sb3,.zip';
        ...
        getProjectTitleFromFilename (fileInputFilename) {
            ...
            // only parse title with valid scratch / usbq project extensions
            // (.sb, .sb2, and .sb3) or (.uqb1)
            const matches = fileInputFilename.match(/^(.*)\.sb[23]?$|^(.*)\.uqb1$/);
            if (!matches) return '';
